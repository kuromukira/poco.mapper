...
namespace POCOMapper.Test
{
    internal struct SourceStruct
    {
        ...
        [MappedTo("OUTER_ST")] public InnerSourceStruct InnerSourceStruct { get; set; }
        [MappedTo("OUTER_ST_LIST")] public IList<InnerSourceStruct> InnerSourceListStruct { get; set; }
        [MappedTo("OUTER_ST_ARRAY")] public InnerSourceStruct[] InnerSourceArrayStruct { get; set; }
    ...
    internal struct InnerSourceStruct
    {
