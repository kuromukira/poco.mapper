...
public record SourceRecord
{
	...
	[MappedTo("OUTER")] public InnerSourceRecord InnerSource { get; set; }
	[MappedTo("OUTER_LIST")] public IList<InnerSourceRecord> InnerSourceList { get; set; }
	[MappedTo("OUTER_ARRAY")] public InnerSourceRecord[] InnerSourceArray { get; set; }
...
public record InnerSourceRecord
{
